...
const BLOG = {
    ...
    NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '50d987c63c684eb5964629826e51d44d',
    ...
    GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '惟有日积月累的努力不会背叛自己',

    CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

    AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tuwilt', // 您的昵称 例如 tangly1024
    BIO: process.env.NEXT_PUBLIC_BIO || '言辞不必有力', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'https:/blog.tuwilt.top', // 网站地址
    ...
    CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Tuwilt', // 你的github个人主页 例如 https://github.com/tangly1024
    ...
    RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://pic.api.weexy.cn/scenery/api.php', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
    RANDOM_IMAGE_REPLACE_TEXT: process.env.NEXT_PUBLIC_RANDOM_IMAGE_NOT_REPLACE_TEXT || 'pic.api.weexy.cn, images.unsplash.com', // 触发替换图片的 url 关键字(多个支持用英文逗号分开)，只有图片地址中包含此关键字才会替换为上方随机图片url
    ...
    BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备2023019648号', // 备案号 闽ICP备XXXXXXX
    ...
    TianliGPT_KEY: process.env.NEXT_PUBLIC_TIANLI_GPT_KEY || 'd8b9b74cfd8cd79da49c',
